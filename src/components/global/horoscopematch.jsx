...
const formSchema = z.object({
    ...
    gbirthhr: z.string().min(2, {
        message: "Please select birth hour.",
    }),
    gbirthmin: z.string().min(2, {
        message: "Please select birth minutes.",
    }),
    gbirthplace: z.string().min(2, {
        message: "Please enter birth place",
    }),
                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="w-full">
                            <div className="flex flex-col lg:flex-row gap-2">
                                <div className="flex-1">
                                    <div>
                                        <h1 className="font-semibold text-md text-center text-primary border py-1">Boys Details</h1>
                                    </div>
                                    <FormField
                                ...
                                <div className='min-h-full w-0.5 bg-primary'></div>
                                <div className="flex-1">
                                    <div>
                                        <h1 className="font-semibold text-md text-center text-primary border py-1">Girls Details</h1>
                                    </div>
                                    <div className="flex gap-2">
                                        <FormField
                                            control={form.control}
